...
def CreateCSV(articles, fname, scores):
    with open(fname, 'w') as file:
        ...
        for a in articles:
            ...
            writer.writerow(
                [a.source, a.published, a.url, scores[rcount], " ", a.anger, a.fear, a.joy, a.sadness, a.analytical,
...
def weekwrite(weeks, section):
    ...
    with open(fname, 'w', newline='') as file:
        ...
        for week in weeks:
            ...
            writer.writerow(
                [week.weekname, Anger_max, Anger_median, Anger_mean, Sad_max, Sad_median, Sad_mean, Fear_max,
                 Fear_median, Fear_mean, Joy_max, Joy_median, Joy_mean, Analy_max, Analy_median, Analy_mean, Confi_max,
                 Confi_median, Confi_mean, Tenta_max, Tenta_median, Tenta_mean])
