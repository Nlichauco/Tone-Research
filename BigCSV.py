...
the_paths = ['/Users/nathaniel/Desktop/Tone-Research/res/GuardianCSVs/Politics']
...
def week_write(weeks, section):
    ...
    with open(file_name, 'w', newline='') as file:
        ...
        writer.writerow(
            ["Week", "Anger_max", "Anger_med", "Anger_avg", "Anger_total","Anger_ratio", "Sad_max", "Sad_median", "Sad_avg",
             "Sad_total","Sad_ratio", "Fear_max", "Fear_med",
             "Fear_avg", "Fear_total","Fear_ratio", "Joy_max", "Joy_med", "Joy_avg", "Joy_total","Joy_ratio", "Analy_max", "Analy_med",
             "Analy_avg", "Analy_total","Analy_ratio", "Confi_max",
             "Confi_med", "Confi_avg", "Confi_total","Confi_ratio", "Tenta_max", "Tenta_med", "Tenta_avg", "Tenta_total","Tenta_ratio"])
        for week in weeks:
            writer.writerow(
                [week.weekname, week.Anger.get_max(), week.Anger.get_median(), week.Anger.get_mean(),
                 week.Anger.get_total(),week.Anger.get_perc(),
                 week.Sadness.get_max(), week.Sadness.get_median(), week.Sadness.get_mean(), week.Sadness.get_total(),week.Sadness.get_perc(),
                 week.Fear.get_max(),
                 week.Fear.get_median(), week.Fear.get_mean(), week.Fear.get_total(),week.Fear.get_perc(), week.Joy.get_max(),
                 week.Joy.get_median(),
                 week.Joy.get_mean(), week.Joy.get_total(),week.Joy.get_perc(), week.Analy.get_max(), week.Analy.get_median(),
                 week.Analy.get_mean(), week.Analy.get_total(),week.Analy.get_perc(),
                 week.Confi.get_max(),
                 week.Confi.get_median(), week.Confi.get_mean(), week.Confi.get_total(), week.Confi.get_perc(), week.Tenta.get_max(),
